...
$arrayAseguradora=$objAseguradora->listaAseguradoras();
?>
  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Lista de Aseguradoras Registrados</h3>
        <div class="box-tools">
        ...
        <div class="col-md-12">
          <button class='btn btn-danger' id='actualizar_tabla_aseguradora' value=""><i class="fa fa-refresh"></i></button>
          <button class='btn btn-warning' id='actualizar_tabla_aseguradora' value=""><i class="fa  fa-file-text"></i> Nuevo Registro</button>
      ...
      <div class="box-body">
        <div id="conductor_contenedor_dinamico">
          <?php  if(is_null($arrayAseguradora)){
            echo "<h3 class='box-title'>No hay REgistros de aseguradoras </h3>";
          }else{
            ...
            foreach ($arrayAseguradora as  $clave => $valor) {
