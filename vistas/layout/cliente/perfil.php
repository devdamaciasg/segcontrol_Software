    ...
    <div class="box box-primary">
      ...
      <form role="form">
        <div class="box-body">
          ...
          <div class="form-group ">
            <input type="password" class="form-control"  placeholder="contraseña actual . . ." disabled>
          </div>

          <p class="help-block">Ingresa tu nueva contraseña.</p>
          <div class="form-group ">
            <input type="password" class="form-control"  placeholder="nueva contraseña . . ." disabled>
          </div>
        ...
        <div class="box-footer">
          <button type="submit" class="btn btn-primary" id="datos_clave">Editar</button>
        </div>
      </form>
    </div><!-- /.box -->
